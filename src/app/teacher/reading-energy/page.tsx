...
export default function ReadingEnergyPage() {
    ...
    const handleBatchConvert = async () => {
        ...
        if (studentsWithReadingEnergy.length === 0) {
            toast({ title: "無可轉換項目", description: "目前沒有學生的閱讀能量大於 0。" });
        ...
        try {
            ...
            toast({
                title: "轉換成功",
                description: `已成功為 ${studentsWithReadingEnergy.length} 位學生轉換閱讀能量，共發放 ${totalPointsToAward.toLocaleString()} 點。`
            });
        } catch (error: any) {
    ...
    return (
        <div className="space-y-6 animate-in fade-in-0 duration-500">
            <Card>
                <CardHeader>
                    <CardTitle className="flex items-center gap-2"><BookUp /> 閱讀能量轉換中心</CardTitle>
                    <CardDescription>
                        此功能用於在每個月初，將上個月累積的全校學生「閱讀能量」批次轉換為點數。請注意：此操作將會消耗學校總資金。
                    </CardDescription>
                </CardHeader>
                <CardContent>
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                        此操作將會把列表中所有學生的「閱讀能量」乘以轉換率，加到他們的總點數中，並將閱讀能量歸零。此操作無法復原。
                                    </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    ...
                                    <TableHead className="text-right">待轉換閱讀能量</TableHead>
